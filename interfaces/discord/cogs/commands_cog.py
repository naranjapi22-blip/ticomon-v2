    ...
    async def commands_command(self, ctx: commands.Context):
        ...
        embed.add_field(
            ...
            value=(
                ...
                "`!mint <collection_number>` — Use a Nature Mint to change a "
                "creature's nature effect.\n"
                "Uses the collection number; the original nature stays intact, "
                "and the mint is consumed only after confirming a valid change.\n"
